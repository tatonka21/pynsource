# This is a COPY of wxasync.py 0.4 which we can play with an insert debugging statemements in, e.g. just replace
# from wxasync import AsyncBind, WxAsyncApp, StartCoroutine
# with
# from wxasync_local import AsyncBind, WxAsyncApp, StartCoroutine
