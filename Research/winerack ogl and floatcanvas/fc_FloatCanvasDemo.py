    ...
    class DrawFrame(wx.Frame):
        ...
        def __init__(self, parent, id, title, position, size):
            ...
            item = draw_menu.Append(
                -1,
                "Hit Test &Foreground",
                "Run a test of the hit test code with a foreground Object",
            )
            ...
            item = draw_menu.Append(
                -1, "Change &Properties", "Run a test of Changing Object Properties"
            )
            ...
            help_menu = wx.Menu()
            item = help_menu.Append(-1, "&About", "More information About this program")
        ...
        def TestAnimation(self, event=None):
            ...
            C = Canvas.AddCircle(
                (0, 0), 7, LineWidth=2, LineColor="Black", FillColor="Red", InForeground=True
            )
            T = Canvas.AddScaledText(
                "Click to Move", (0, 0), Size=0.6, Position="cc", InForeground=True
            )
        ...
        def TestHitTest(self, event=None):
            ...
            y += dy
            L = Canvas.AddLine(
                ((x, y), (x + 10, y + 10), (x + w, y + h)), LineWidth=2, LineColor="Red"
            )
            L.Name = "A Line"
            ...
            x += dx
            T = Canvas.AddScaledText(
                "Scaled Text", (x, y), Size=1.0 / 2 * h, Color="Pink", Position="bl"
            )
        ...
        def TestHitTestForeground(self, event=None):
            ...
            color = "Red"
            R = Canvas.AddRectangle(
                (x, y), (w, h), LineWidth=2, FillColor=color, InForeground=False
            )
            R.Name = color + "Rectangle"
            R.HitFill = True
            R.Bind(FloatCanvas.EVT_FC_LEFT_DOWN, self.RectGotHit)
        ...
        def TestText(self, event=None):
            ...
            self.Canvas.AddText(
                "Bottom Center", Point, Size=DefaultSize, Color="White", Position="bc"
            )
            ...
            Canvas.AddPointSet((Point), Color="White", Diameter=2)
            self.Canvas.AddText(
                "Center Right", Point, Size=DefaultSize, Color="Black", Position="cr"
            )
            self.Canvas.AddText(
                "Center Left", Point, Size=DefaultSize, Color="Black", Position="cl"
            )
            ...
            Canvas.AddPointSet((Point), Color="White", Diameter=2)
            self.Canvas.AddText(
                "Center Center", Point, Size=DefaultSize, Color="Black", Position="cc"
            )
        ...
        def TestScaledText(self, event=None):
            ...
            T = Canvas.AddScaledText(
                "Top Left", Point, Size=5, Color="Yellow", BackgroundColor="Blue", Position="tl"
            )
            T = Canvas.AddScaledText(
                "Bottom Left", Point, Size=5, Color="Cyan", BackgroundColor="Black", Position="bl"
            )
            T = Canvas.AddScaledText(
                "Top Right", Point, Size=5, Color="Black", BackgroundColor="Cyan", Position="tr"
            )
            T = Canvas.AddScaledText(
                "Bottom Right", Point, Size=5, Color="Blue", BackgroundColor="Yellow", Position="br"
            )
            ...
            self.Canvas.AddScaledText(
                "MODERN Font", (x, 0), Size=7, Family=wx.MODERN, Color=(0, 0, 0)
            )
            self.Canvas.AddScaledText(
                "DECORATIVE Font", (x, -10), Size=7, Family=wx.DECORATIVE, Color=(0, 0, 1)
            )
            ...
            self.Canvas.AddScaledText(
                "ROMAN BOLD Font", (x, -40), Size=7, Family=wx.ROMAN, Weight=wx.BOLD
            )
            self.Canvas.AddScaledText(
                "ROMAN ITALIC BOLD Font",
                (x, -50),
            ...
            T = self.Canvas.AddScaledText(
                "Helvetica Italic", Point, Size=20, Font=Font, Position="bc"
            )
        ...
        def TestScaledTextBox(self, event=None):
            ...
            Box = Canvas.AddScaledTextBox(
                "Some more auto wrapped text. Wrapped to a different width.\n\nThis is another paragraph.",
                (80, 20),
                2,
                BackgroundColor="White",
                LineWidth=2,
        ...
        def TestBitmap(self, event=None):
            ...
            Canvas.AddRectangle(
                (10, 20), (400, 100), LineWidth=3, LineColor="Blue", FillColor="Red"
            )
        ...
        def DrawMap(self, event=None):
            ...
            Shorelines = self.Read_MapGen(os.path.join(".", "fc_world.dat"), stats=0)
        ...
        def PropertiesChangeTest(self, event=None):
            ...
            Canvas.AddScaledText(
                "Click Here To Change Properties",
                (0, -10.5),
                Size=0.7,
                Color="Black",
                Position="cc",
        ...
        def ArrowTest(self, event=None):
            ...
            Canvas.AddArrow(
                (10, 10), Length=50, Direction=45, LineWidth=2, LineColor="Black", ArrowHeadAngle=20
            )
            Canvas.AddArrow(
                (10, 10), Length=60, Direction=90, LineWidth=3, LineColor="Red", ArrowHeadAngle=30
            )
            Canvas.AddArrow(
                (10, 10), Length=70, Direction=135, LineWidth=4, LineColor="Red", ArrowHeadAngle=40
            )
            Canvas.AddArrow(
                (10, 10), Length=80, Direction=180, LineWidth=5, LineColor="Blue", ArrowHeadAngle=50
            )
            Canvas.AddArrow(
                (10, 10), Length=90, Direction=225, LineWidth=4, LineColor="Blue", ArrowHeadAngle=60
            )
            Canvas.AddArrow(
                (10, 10),
                Length=100,
            ...
            Arrow = Canvas.AddArrow(
                (4, 18), 80, Direction=90, LineWidth=3, LineColor="Red", ArrowHeadAngle=30
            )
            ...
            self.RotArrow = Canvas.AddArrow(
                (16, 4), 80, Direction=0, LineWidth=3, LineColor="Green", ArrowHeadAngle=30
            )
        ...
        def HideTest(self, event=None):
            ...
            HideButton = Canvas.AddScaledTextBox(
                "Click To Hide\nBackground Polygon",
                (-10, 0),
                0.5,
                BackgroundColor="Red",
            ...
            HideButton2 = Canvas.AddScaledTextBox(
                "Click To Hide\nForeground Polygon",
                (-10, 5),
                0.5,
                BackgroundColor="Red",
            ...
            for line in data:
                if line:
                    if line == "# -b":  # New segment beginning
                        if segment:
                            Shorelines.append(N.array(segment))
                        segment = []
                    else:
    ...
    if not haveNumpy:
        ...
        class TestPanel(wx.Panel):
            ...
            def OnButton(self, evt):
                DrawFrame = BuildDrawFrame()
                frame = DrawFrame(
                    None, -1, "FloatCanvas Drawing Window", wx.DefaultPosition, (500, 500)
                )
